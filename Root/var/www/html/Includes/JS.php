		...
		<script type="text/javascript" src="<?=$domain; ?>/AI/GeniSysAI/Media/JS/GeniSysAi.js"></script>
		<script type="text/javascript" src="<?=$domain; ?>/AI/GeniSysAI/Media/JS/Logging.js"></script>
