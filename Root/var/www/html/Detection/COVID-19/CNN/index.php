...
include dirname(__FILE__) . '/../../../Detection/COVID-19/CNN/Classes/COVID19.php';
...
<html lang="en">
    ...
    <body id="GeniSysAI">
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-default card-view">
                            <div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">HIAS COVID-19 Detection System</h6>
								</div>
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
                                    ...
                                    <p>To use this diagnosis system you need to complete the <a href="https://github.com/COVID-19-AI-Research-Project/AI-Classification/tree/master/Projects/3" title="Peter Moss COVID-19 Tensorflow DenseNet Classifier For Raspberry Pi 4" target="_BLANK">COVID-19 Tensorflow DenseNet Classifier For Raspberry Pi 4</a> tutorial from our Github account and make sure that the classification server is running and accepting connections.</p>
                                    <p>&nbsp;</p>
        ...
        <script type="text/javascript" src="<?=$domain; ?>/Detection/COVID-19/CNN/Classes/COVID19.js"></script>
