				...
				<div class="row">
					<div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-default card-view panel-refresh">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">Create ALL Classifier Device</h6>
								</div>
										...
										<div class="row">
											<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
												...
												<div class="form-group">
													...
													<select class="form-control" id="category" name="category" required>
														...
														<option value="<?=$value["category"]; ?>" <?=$value["category"] == "ALLClassifier" ? " selected" : ""; ?>><?=$value["category"]; ?></option>
											...
											<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" id="sport" name="sport" placeholder="ALL Device Server Port" required value="">
													<span class="help-block">Server port of ALL classifier device</span>
												</div>
												<div class="form-group">
													<label for="name" class="control-label mb-10">Proxy Endpoint</label>
													<input type="text" class="form-control hider" id="endpoint" name="endpoint" placeholder="ALL Device Stream Directory" required value="">
