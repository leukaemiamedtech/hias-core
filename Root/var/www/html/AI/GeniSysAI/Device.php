				...
				<div class="row">
					<div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-default card-view panel-refresh">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">GeniSysAI Security NLU Device #<?=$TId; ?></h6>
								</div>
											...
											<div class="row">
												...
												<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
													...
													<div class="form-group">
														...
														<input type="text" class="form-control" id="coordinates" name="coordinates" placeholder="iotJumpWay Location coordinates" required value="<?=$Device["context"]["Data"]["location"]["value"]["coordinates"][0]; ?>, <?=$Device["context"]["Data"]["location"]["value"]["coordinates"][1]; ?>">
													...
													<div class="form-group">
														...
														<input type="text" class="form-control hider" id="apidir" name="apidir" placeholder="Nginx server proxy path" required value="<?=$Device["context"]["Data"]["proxy"]["endpoint"]; ?>">
						...
						<div class="panel panel-default card-view panel-refresh">
							<div class="panel-heading">
								...
								<div class="pull-right"><a href="<?=$domain; ?>/iotJumpWay/<?=$Device["context"]["Data"]["lid"]["value"]; ?>/Zones/<?=$Device["context"]["Data"]["zid"]; ?>/Devices/<?=$Device["context"]["Data"]["did"]["value"]; ?>/History"><i class="fa fa-eye pull-left"></i> View All Device History</a></div>
								<div class="clearfix"></div>
							</div>
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
												  ...
												  <tr>
													...
													<td>
														...
														<?php
															if($value["hash"]):
														?>
															<a href="<?=$domain; ?>/iotJumpWay/<?=$Device["context"]["Data"]["lid"]["value"]; ?>/Zones/<?=$Device["context"]["Data"]["zid"]; ?>/Devices/<?=$Device["context"]["Data"]["did"]["value"]; ?>/Transaction/<?=$value["hash"];?>">#<?=$value["hash"];?></a>
														<?php
															else:
														?>
															NA
						...
						<div class="panel panel-default card-view panel-refresh">
							<div class="panel-heading">
								...
								<div class="pull-right"><a href="<?=$domain; ?>/iotJumpWay/<?=$Device["context"]["Data"]["lid"]["value"]; ?>/Zones/<?=$Device["context"]["Data"]["zid"]; ?>/Devices/<?=$Device["context"]["Data"]["did"]["value"]; ?>/Transactions"><i class="fa fa-eye pull-left"></i> View All Device Transactions</a></div>
								<div class="clearfix"></div>
							</div>
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
											...
											<table class="table mb-0">
												...
												?>
												  ...
												  <tr>
													<td>#<?=$value["id"];?></td>
													<td><?=$userDetails;?><?=$value["action"];?></td>
													<td><a href="<?=$domain; ?>/iotJumpWay/<?=$Device["context"]["Data"]["lid"]["value"]; ?>/Zones/<?=$Device["context"]["Data"]["zid"]; ?>/Devices/<?=$Device["context"]["Data"]["did"]["value"]; ?>/Transaction/<?=$value["id"];?>">#<?=$value["id"];?></a></td>
													<td><?=date("Y-m-d H:i:s", $value["time"]);?></td>
												  </tr>
						...
						<div class="panel panel-default card-view panel-refresh">
							<div class="panel-heading">
								...
								<div class="pull-right"><a href="<?=$domain; ?>/iotJumpWay/<?=$Device["context"]["Data"]["lid"]["value"]; ?>/Zones/<?=$Device["context"]["Data"]["zid"]; ?>/Devices/<?=$Device["context"]["Data"]["did"]["value"]; ?>Statuses"><i class="fa fa-eye pull-left"></i> View All Device Status Data</a></div>
								<div class="clearfix"></div>
							</div>
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<div class="table-wrap mt-40">
										<div class="table-responsive">
											<table class="table mb-0">
												...
												<?php
													$Statuses = $iotJumpWay->retrieveDeviceStatuses($Device["context"]["Data"]["id"], 5);
						...
						<div class="panel panel-default card-view panel-refresh">
							<div class="panel-heading">
								...
								<div class="pull-right"><a href="<?=$domain; ?>/iotJumpWay/<?=$Device["context"]["Data"]["lid"]["value"]; ?>/Zones/<?=$Device["context"]["Data"]["zid"]; ?>/Devices/<?=$Device["context"]["Data"]["did"]["value"]; ?>/Life"><i class="fa fa-eye pull-left"></i> View All Device Life Data</a></div>
								<div class="clearfix"></div>
							</div>
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<div class="table-wrap mt-40">
										<div class="table-responsive">
											<table class="table mb-0">
												...
												<?php
													$Statuses = $iotJumpWay->retrieveDeviceLife($Device["context"]["Data"]["id"], 5);
													if($Statuses["Response"] == "OK"):
														foreach($Statuses["ResponseData"] as $key => $value):
												?>
						...
						<div class="panel panel-default card-view panel-refresh">
							<div class="panel-heading">
								...
								<div class="pull-right"><a href="<?=$domain; ?>/iotJumpWay/<?=$Device["context"]["Data"]["lid"]["value"]; ?>/Zones/<?=$Device["context"]["Data"]["zid"]; ?>/Devices/<?=$Device["context"]["Data"]["did"]["value"]; ?>/Sensors"><i class="fa fa-eye pull-left"></i> View All Device Sensors Data</a></div>
								<div class="clearfix"></div>
							</div>
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<div class="table-wrap mt-40">
										<div class="table-responsive">
											<table class="table mb-0">
												...
												<?php
													$Statuses = $iotJumpWay->retrieveDeviceSensors($Device["context"]["Data"]["id"], 5);
													if($Statuses["Response"] == "OK"):
														foreach($Statuses["ResponseData"] as $key => $value):
						...
						<div class="panel panel-default card-view panel-refresh">
							<div class="panel-heading">
								...
								<div class="pull-right"><a href="<?=$domain; ?>/iotJumpWay/<?=$Device["context"]["Data"]["lid"]["value"]; ?>/Zones/<?=$Device["context"]["Data"]["zid"]; ?>/Devices/<?=$Device["context"]["Data"]["did"]["value"]; ?>/Commands"><i class="fa fa-eye pull-left"></i> View All Device Commands Data</a></div>
								<div class="clearfix"></div>
							</div>
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<div class="table-wrap mt-40">
										<div class="table-responsive">
											<table class="table mb-0">
												...
												<?php
													$Statuses = $iotJumpWay->retrieveDeviceCommands($Device["context"]["Data"]["id"], 5);
													if($Statuses["Response"] == "OK"):
														foreach($Statuses["ResponseData"] as $key => $value):
															$location = $iotJumpWay->getLocation($value->Location);
						...
						<div class="panel panel-default card-view panel-refresh">
							<div class="panel-wrapper collapse in">
								...
								<div class="pull-right"></div>
									<div class="form-group">
										<div class="col-md-12">
  											<div style="overflow-y: scroll; overflow-x: hidden; height: 250px; margin-bottom: 10px;" id="chatWindow"></div>
											<form data-toggle="validator" role="form" id="genisysai_chat">
												...
												<button type="submit" class="btn btn-success btn-anim" id="send_chat" style="width: 100%;"><i class="icon-rocket"></i><span class="btn-text">Submit</span></button>
											</form>
										</div>
									</div>
								</div>
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<p class="form-control-static" id="idappid"><?=$Device["context"]["Data"]["keys"]["public"]; ?></p>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<p class="form-control-static" id="mqttut"><?=$_GeniSys->_helpers->oDecrypt($Device["context"]["Data"]["mqtt"]["username"]); ?></p>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-5">MQTT Password</label>
										<div class="col-md-9">
											<p class="form-control-static"><span id="mqttpt"><?=$_GeniSys->_helpers->oDecrypt($Device["context"]["Data"]["mqtt"]["password"]); ?></span>
											</p>
										</div>
									</div>
								</div>
