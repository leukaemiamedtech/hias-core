...
<html lang="en">
	...
	<body id="GeniSysAI">
				...
				<div class="row">
					<div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-default card-view panel-refresh">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">Create AML Classifier Device</h6>
								</div>
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<div class="form-wrap">
										<form data-toggle="validator" role="form" id="aml_classifier">
										<div class="row">
											<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
												...
												<div class="form-group">
													...
													<select class="form-control" id="category" name="category" required>
														...
														<option value="<?=$value["category"]; ?>" <?=$value["category"] == "AML Classifier" ? " selected" : ""; ?>><?=$value["category"]; ?></option>
												...
												<div class="form-group">
													...
													<span class="help-block"> Type of AML model</span>
												</div>
												<div class="form-group">
												...
												<div class="form-group mb-0">
													<input type="hidden" class="form-control" id="create_aml_classifier" name="create_aml_classifier" required value="1">
													<button type="submit" class="btn btn-success btn-anim" id="aml_classifier_create"><i class="icon-rocket"></i><span class="btn-text">submit</span></button>
												</div>
											</div>
											<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
												<div class="form-group">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" id="sport" name="sport" placeholder="AML Device Server Port" required value="">
													<span class="help-block">Server port of AML classifier device</span>
												</div>
												<div class="form-group">
													<label for="name" class="control-label mb-10">Proxy Endpoint</label>
													<input type="text" class="form-control hider" id="endpoint" name="endpoint" placeholder="AML Device Stream Directory" required value="">
		...
		<script type="text/javascript" src="<?=$domain; ?>/AI/AML/Classes/AML.js"></script>
