	 	 	 	 ...
	 	 	 	 <div class="row">
	 	 	 	 	 <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
	 	 	 	 	 	 <div class="panel panel-default card-view panel-refresh">
	 	 	 	 	 	 	 <div class="panel-heading">
	 	 	 	 	 	 	 	 <div class="pull-left">
	 	 	 	 	 	 	 	 	 <h6 class="panel-title txt-dark">AML Classifier Device #<?=$TId; ?></h6>
	 	 	 	 	 	 	 	 </div>
	 	 	 	 	 	 	 ...
	 	 	 	 	 	 	 <div class="panel-wrapper collapse in">
	 	 	 	 	 	 	 	 <div class="panel-body">
	 	 	 	 	 	 	 	 	 <div class="form-wrap">
	 	 	 	 	 	 	 	 	 	 <form data-toggle="validator" role="form" id="aml_classifier_update">
	 	 	 	 	 	 	 	 	 	 	 <div class="row">
													...
													<div class="form-group mb-0">
														<input type="hidden" class="form-control" id="update_aml_classifier" name="update_aml_classifier" required value="1">
												...
												<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
													...
													<div class="form-group">
														...
														<input type="text" class="form-control hider" id="sport" name="sport" placeholder="AML Device Stream Port" required value="<?=$Device["context"]["Data"]["stream"]["port"]; ?>">
														<span class="help-block">Port of AML stream</span>
													</div>
													<div class="form-group">
														<label for="name" class="control-label mb-10">Proxy Endpoint</label>
														<input type="text" class="form-control hider" id="endpoint" name="endpoint" placeholder="AML Device Proxy Endpoint" required value="<?=$Device["context"]["Data"]["proxy"]["endpoint"]; ?>">
