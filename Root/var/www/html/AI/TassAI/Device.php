	 	 	 	 ...
	 	 	 	 <div class="row">
	 	 	 	 	 <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
	 	 	 	 	 	 <div class="panel panel-default card-view panel-refresh">
	 	 	 	 	 	 	 <div class="panel-heading">
	 	 	 	 	 	 	 	 <div class="pull-left">
	 	 	 	 	 	 	 	 	 <h6 class="panel-title txt-dark">TassAI Facial Recognition Device #<?=$TId; ?></h6>
	 	 	 	 	 	 	 	 </div>
	 	 	 	 	 	 	 	 ...
	 	 	 	 	 	 	 	 <div class="panel-body">
	 	 	 	 	 	 	 	 	 <div class="form-wrap">
	 	 	 	 	 	 	 	 	 	 <form data-toggle="validator" role="form" id="genisysai_update">
													...
													<div class="form-group">
														<label class="control-label mb-10">Camera Type</label>
														<select class="form-control" id="type" name="type" required>
															<option value="">PLEASE SELECT</option>
															<option value="API" <?=$Device["context"]["Data"]["device"]["type"] == "API" ? " selected " : ""; ?>>API</option>
															<option value="Realsense D415" <?=$Device["context"]["Data"]["device"]["type"] == "Realsense D415" ? " selected " : ""; ?>>Realsense D415</option>
															<option value="Realsense F200" <?=$Device["context"]["Data"]["device"]["type"] == "Realsense F200" ? " selected " : ""; ?>>Realsense F200</option>
															<option value="Realsense R200" <?=$Device["context"]["Data"]["device"]["type"] == "Realsense R200" ? " selected " : ""; ?>>Realsense R200</option>
															<option value="Foscam Camera" <?=$Device["context"]["Data"]["device"]["type"] == "Foscam Camera" ? " selected " : ""; ?>>Foscam Camera</option>
															<option value="USB Camera" <?=$Device["context"]["Data"]["device"]["type"] == "USB Camera" ? " selected " : ""; ?>>USB Camera</option>
														</select>
														<span class="help-block"> Location of TassAI camera device</span>
													</div>
													<div class="form-group">
													...
													<div class="form-group mb-0">
														...
														<input type="hidden" class="form-control" id="identifier" name="identifier" required value="<?=$Device["context"]["Data"]["id"]; ?>">
														<input type="hidden" class="form-control" id="status" name="status" required value="<?=$Device["context"]["Data"]["status"]["value"]; ?>">
												...
												<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
													...
													<div class="form-group">
														...
														<span class="help-block">Port of TassAI stream</span>
													</div>
													<div class="form-group">
														...
														<span class="help-block">File of TassAI stream (.mjpg)</span>
													</div>
													<div class="form-group">
						...
						<div class="panel panel-default card-view panel-refresh">
							<div class="panel-wrapper collapse in">
	 	 	 	 	 	 ...
	 	 	 	 	 	 <div class="panel panel-default card-view panel-refresh <?=$Device["context"]["Data"]["device"]["type"] == "API" ? "hide" : ""; ?>">
	 	 	 	 	 	 	 <div class="panel-wrapper collapse in">
	 	 	 	 	 	 	 	 <div class="panel-body">
	 	 	 	 	 	 	 	 	 <img src="<?=$domain; ?>/TassAI/<?=$Device["context"]["Data"]["proxy"]["endpoint"]; ?>/<?=$Device["context"]["Data"]["stream"]["file"]; ?>" style="width: 100%;" />
	 	 	 	 	 	 	 	 </div>
	 	 	 	 	 	 	 </div>
	 	 	 	 	 	 </div>
	 	 	 	 	 	 <div class="panel panel-default card-view panel-refresh">
