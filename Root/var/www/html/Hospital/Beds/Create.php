                                    ...
                                    <div class="form-wrap">
                                        <form data-toggle="validator" role="form" id="form">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="help-block"> MAC bed chip</span> 
                                            </div>
								            <div class="clearfix"></div>
                                            <hr class="light-grey-hr"/>
                                            <div class="form-group mb-0">
                                                <input type="hidden" class="form-control" id="create_bed" name="create_bed" required value="1">
                                                <button type="submit" class="btn btn-success btn-anim" id="bed_create"><i class="icon-rocket"></i><span class="btn-text">submit</span></button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
