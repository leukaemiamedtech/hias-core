				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="panel panel-default card-view panel-refresh">
                            <div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark"><i class="fa fa-bed"></i> Beds</h6>
								</div>
								<div class="pull-right"><a href="<?=$domain; ?>/Hospital/Beds/Create"><i class="fa fa-plus"></i></a></div> 
										...
										<div class="table-responsive">
											<table class="table mb-0">
												...
												?>
												  ...
												  <tr>
													<td>#<?=$value["id"];?></td>
													<td><?=$_GeniSys->_helpers->oDecrypt($value["ip"]);?></td>
													<td><a href="<?=$domain; ?>/Hospital/Beds/<?=$value["id"];?>/"><i class="fa fa-edit"></i></a></a></td>
												  </tr>
