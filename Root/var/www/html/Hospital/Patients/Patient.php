				...
				<div class="row">
					<div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                        <div class="panel panel-default card-view panel-refresh">
                            <div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark"><i class="fa fa-hospital-user"></i> Patient #<?=$PId; ?></h6>
								</div>
                                    ...
                                    <div class="form-wrap">
                                        <form data-toggle="validator" role="form" id="form">
                                            ...
                                            <div class="form-group clearfix">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static"><?=$Patient["lt"] ? $Patient["lt"] : "NA"; ?></p>
                                                    <span class="help-block"> Latitude of patient</span> 
                                                </div>
                                            </div>
                                            <div class="form-group clearfix">
                                                <label class="control-label col-md-5">Longitude</label>
                                                <div class="col-md-9">
                                                    <p class="form-control-static"><?=$Patient["lg"] ? $Patient["lg"] : "NA"; ?></p>
                                                    <span class="help-block"> Longitude of patient</span> 
                                                </div>
                                            </div>	
                                            <hr class="light-grey-hr"/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control" id="email" name="email" placeholder="Email of patient" required value="<?=$Patient["email"]; ?>">
                                                <span class="help-block"> Email of patient</span> 
                                            </div>
                                            <div class="form-group">
                                                <label for="name" class="control-label mb-10">Username</label>
                                                <input type="text" class="form-control" id="username" name="username" placeholder="TASS Device Name" required value="<?=$Patient["username"]; ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="lid" name="lid">
                                                    ...
                                                    <option value="<?=$value["id"]; ?>" <?=$Patient["lid"] == $value["id"] ? " selected " : ""; ?>>#<?=$value["id"]; ?>: <?=$value["name"]; ?></option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="aid" name="aid">
                                                    ...
                                                    <option value="<?=$value["id"]; ?>" <?=$Patient["aid"] == $value["id"] ? " selected " : ""; ?>>#<?=$value["id"]; ?>: <?=$value["name"]; ?></option>
                                            ...
                                            <div class="form-group mb-0">
                                                ...
                                                <button type="submit" class="btn btn-success btn-anim" id="patient_update"><i class="icon-rocket"></i><span class="btn-text">submit</span></button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
					...
					<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                        <div class="panel panel-default card-view panel-refresh">
                            <div class="panel-wrapper collapse in">
                                <div class="panel-body">
                                    <img src="<?=$domain; ?>/Hospital/Patients/Media/Images/Uploads/<?=$Patient["pic"];?>" style="width: 100%; !important;" />
                                </div>
                            </div>
                        </div>
					</div>
					<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                        <div class="panel panel-default card-view panel-refresh">
                            <div class="panel-wrapper collapse in">
                                <div class="panel-body">
								    <div class="pull-right"><a href="javascipt:void(0)" id="reset_patients_mqtt"><i class="fa fa-refresh"></i> Reset MQTT Password</a></div>
                                    <div class="form-group">
										<label class="control-label col-md-5">MQTT Username</label>
                                        <div class="col-md-9">
                                            <p class="form-control-static"><?=$_GeniSys->_helpers->oDecrypt($Patient["mqttu"]); ?></p>
                                        </div>
                                    </div>
                                    <div class="form-group">
										<label class="control-label col-md-5">MQTT Password</label>
                                        <div class="col-md-9">
                                            <p class="form-control-static"><span id="mqttp"><?=$_GeniSys->_helpers->oDecrypt($Patient["mqttp"]); ?></span></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
