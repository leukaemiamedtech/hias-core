...
include dirname(__FILE__) . '/../GeniSysAI/Classes/NLU.php';
...
$TDevice = $NLU->getDevice($TId);

list($dev1On, $dev1Off) = $NLU->getStatusShow($TDevice["status"]);
list($lat, $lng) = $NLU->getMapMarkers($TDevice);
...
<body id="GeniSysAI">
	...
	<div class="wrapper theme-6-active pimary-color-pink">
											...
											<div class="row">
												<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
													<div class="form-group">
														...
														<input type="text" class="form-control" id="name" name="name"
															...
															value="<?=$TDevice["name"]; ?>">
														<span class="help-block"> Name of GeniSysAI NLU device</span>
													</div>
													<div class="form-group">
														...
														<span class="help-block"> Location of GeniSysAI NLU device</span>
													</div>
													<div class="form-group">
														...
														<span class="help-block"> Zone of GeniSysAI NLU device</span>
													</div>
													<div class="form-group">
												...
												<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
													<div class="form-group">
														...
														<span class="help-block"> IP of GeniSysAI NLU device</span>
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														...
														<input type="text" class="form-control hider" id="apidir" name="apidir" placeholder="Nginx server proxy path" required value="<?=$TDevice["apidir"] ? $_GeniSys->_helpers->oDecrypt($TDevice["apidir"]) : ""; ?>">
		...
		<script type="text/javascript" src="<?=$domain; ?>/GeniSysAI/Classes/NLU.js"></script>
