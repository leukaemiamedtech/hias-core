...
$txn = $Blockchain->retrieveContractTransaction(filter_input(INPUT_GET, 'transaction', FILTER_SANITIZE_NUMBER_INT));
$receipt = $Blockchain->retrieveContractTransactionReceipt($Blockchain->_GeniSys->_helpers->oDecrypt($txn["hash"]));
				...
				<div class="row">
					<div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-default card-view panel-refresh">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">HIAS Blockchain Contract #<?=$contract["id"]; ?> Transaction  #<?=$txn["id"]; ?></h6>
								</div>
