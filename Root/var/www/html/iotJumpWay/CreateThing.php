				...
				<div class="row">
					<div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-default card-view panel-refresh">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">Create iotJumpWay Thing</h6>
								</div>
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<div class="form-wrap">
										<form data-toggle="validator" role="form" id="sensor_update_form" action="<?=$domain; ?>/iotJumpWay/Things/Upload" method="POST" enctype="multipart/form-data" target="uploader">
											<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
												<div class="form-group">
													<label for="name" class="control-label mb-10">Name</label>
													<input type="text" class="form-control" id="name" name="name" placeholder="Things Name" required value="">
													<span class="help-block">Name of Thing</span>
												</div>
												<div class="form-group">
													<label for="name" class="control-label mb-10">Description</label>
													<input type="text" class="form-control" id="description" name="description" placeholder="Things Name" required value="">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" id="manufacturer" name="manufacturer" placeholder="Thing manufacturer" required value="">
													<span class="help-block">Name of thing manufacturer</span>
												</div>
												<div class="form-group">
													<label for="name" class="control-label mb-10">Model</label>
													<input type="text" class="form-control" id="model" name="model" placeholder="Thing model" required value="">
												...
												<div class="form-group mb-0">
													<button type="submit" class="btn btn-success btn-anim" id="update_thing"><i class="icon-rocket"></i><span class="btn-text">Create Thing</span></button>
												</div>
											</div>
											<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
												<div class="form-group">
