				...
				<div class="row">
					<div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-default card-view panel-refresh">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">iotJumpWay Sensor/Actuator #<?=$SId; ?></h6>
								</div>
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<div class="form-wrap">
										<form data-toggle="validator" role="form" id="sensor_update_form" action="<?=$domain; ?>/iotJumpWay/Sensors/Update" method="POST" enctype="multipart/form-data" target="uploader">
											<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
												...
												<div class="form-group mb-0">
													...
													<button type="submit" class="btn btn-success btn-anim" id="update_create"><i class="icon-rocket"></i><span class="btn-text">Update Sensor/Actuator</span></button>
												</div>
											</div>
											<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
												<div class="form-group">
