...
$agents = $ContextBroker->getAgents();
				...
				<div class="row">
					<div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-default card-view panel-refresh">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">HIAS HDSI IoT Agents</h6>
								</div>
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									...
									<p>The HIAS HDSI (HIAS Data Services Interface) IoT Agents are a selection of protocol/transfer specific applications that act as a bridge between the HIAS Context Broker and the devices and applications connected to the HIAS network via the iotJumpWay. Supported protocols currently include HTTP, MQTT, Websockets & AMQP.</p>
									<p>&nbsp;</p>
				...
				<div class="row">
					<div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-default card-view panel-refresh">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">Available IoT Agents</h6>
								</div>
								<div class="pull-right"><a href="<?=$domain; ?>/iotJumpWay/ContextBroker/Agents/Create"><i
											...
											<table class="table mb-0">
												...
												?>
													...
													<tr>
														...
														<td><a href="<?=$domain; ?>/iotJumpWay/ContextBroker/Agents/Agent/<?=$value["aid"]["value"];?>"><i class="fa fa-edit"></i> Edit</a></td>
													</tr>
