...
if [ "$cmsg" = "Y" -o "$cmsg" = "y" ]; then
	...
	geth -datadir /fserver/ethereum/HIAS init /fserver/ethereum/HIAS/genesis.json
	...
	php Scripts/Installation/PHP/Blockchain.php "Contract" "$pcaddress" "HIAS" "$haddress" "$pctransaction" "$iabi"
