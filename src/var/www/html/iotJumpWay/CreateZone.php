											...
											<div class="row">
												<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
													...
													<div class="form-group">
														...
														<input type="text" class="form-control" id="description" name="description" placeholder="Location description" required value="">
														<span class="help-block"> Description of Zone</span>
													</div>
													<div class="form-group">
														<label for="name" class="control-label mb-10">Coordinates</label>
														<input type="text" class="form-control" id="coordinates" name="coordinates" placeholder="Location coordinates" required value="">
														<span class="help-block">Zone coordinates</span>
													</div>
