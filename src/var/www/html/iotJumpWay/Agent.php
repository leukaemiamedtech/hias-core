...
$agent = $iotJumpWayAgents->get_agent($aid, "dateCreated,dateModified,*");

list($appOn, $appOff) = $iotJumpWay->get_device_status($agent["networkStatus"]["value"]);

//$cancelled = $agent["permissionCancelled"]["value"] ? True : False;
$cancelled = False;

$data = $iotJumpWayAgents->agent_life_graph($aid, 100);
...
<html lang="en">
    ...
    <body id="GeniSysAI">
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                        <div class="panel panel-default card-view panel-refresh">
                            <div class="panel-heading">
                                <div class="pull-left">
                                    <h6 class="panel-title txt-dark">Agent Resource Monitor</h6>
                                </div>
                        ...
                        <div class="panel panel-default card-view panel-refresh">
                            <div class="panel-heading">
                                ...
                                <div class="pull-right"><a href="/iotJumpWay/Agents/Agent/<?=$agent["id"]; ?>/Configuration" download><i class="fas fa-download"></i> Agent Credentials</a></div>
                                <div class="clearfix"></div>
                            </div>
                            <div class="panel-wrapper collapse in">
                                <div class="panel-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control hider" id="ip" name="ip" placeholder="agent IP" required value="<?=$agent["ipAddress"]["value"]; ?>" <?=$cancelled ? " disabled " : ""; ?>>
                                                        <span class="help-block"> IP of agent</span>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="name" class="control-label mb-10">MAC</label>
                                                        <input type="text" class="form-control hider" id="mac" name="mac" placeholder="agent MAC" required value="<?=$agent["macAddress"]["value"]; ?>" <?=$cancelled ? " disabled " : ""; ?>>
                                                        <span class="help-block"> MAC of agent</span>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="name" class="control-label mb-10">Bluetooth Address</label>
                                                        <input type="text" class="form-control hider" id="bluetooth" name="bluetooth" placeholder="agent Bluetooth Address"  value="<?=$agent["bluetoothAddress"]["value"]; ?>" <?=$cancelled ? " disabled " : ""; ?>>
                                        ...
                                        <div class="table-wrap mt-40">
                                            <div class="table-responsive">
                                                <table class="table mb-0">
                                                    ...
                                                    <?php
                                                        $userDetails = "";
                                                        $history = $iotJumpWayAgents->get_agent_history($agent["id"], 100);
                                                        if(count($history)):
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="panel panel-default card-view panel-refresh">
                            <div class="panel-wrapper collapse in">
                                <div class="panel-body">
                                    <div class="pull-right"><a href="javascipt:void(0)" id="reset_agent_key"><i class="fa fa-refresh"></i> Reset API Key</a></div>
                                    <div class="form-group">
                            ...
                            <div class="panel-wrapper collapse in">
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <p class="form-control-static hiderstr" id="agentamqpp"><?=$agent["authenticationAmqpKey"]["value"] ? $HIAS->helpers->oDecrypt($agent["authenticationAmqpKey"]["value"]) : ""; ?></p>
        ...
        <script type="text/javascript" src="/iotJumpWay/Classes/iotJumpWayAgents.js"></script>
