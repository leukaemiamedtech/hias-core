                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="panel panel-default card-view panel-refresh">
                            <div class="panel-heading">
                                <div class="pull-left">
                                    <h6 class="panel-title txt-dark">HIAS Applications</h6>
                                </div>
                                <div class="pull-right"><a href="/iotJumpWay/Applications/Create"><i class="fas fa-plus-circle"></i> Create Application</a></div>
                            ...
                            <div class="panel-wrapper collapse in">
                                <div class="panel-body">
                                    ...
                                    <?php
                                        $Applications = $iotJumpWay->get_applications();
                                    ...
                                    <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                                        <div class="panel-wrapper collapse in small" style="background: #333; margin: 5px; padding: 10px; color: #fff;">
                                            ...
                                            <br /><strong>Name:</strong> <a href="/iotJumpWay/<?=$value["networkLocation"]["value"];?>/Applications/<?=$value["id"];?>"><strong><?=$value["name"]["value"];?></strong></a><br />
                                            <strong>Type:</strong> <?=$value["category"]["value"][0];?>
                                            <p>&nbsp;</p>

                                            <a href="/iotJumpWay/<?=$value["networkLocation"]["value"];?>/Applications/<?=$value["id"];?>"><i class="fa fa-edit"></i>&nbsp;Edit</a><br /><br />
