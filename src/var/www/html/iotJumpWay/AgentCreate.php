					...
					<div class="row">
						<div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
							<div class="panel panel-default card-view panel-refresh">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Create HIAS IoT Agent</h6>
									</div>
											...
											<form data-toggle="validator" role="form" id="iot_agent_create">
												<div class="row">
													<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
														...
														<div class="form-group">
															<label for="name" class="control-label mb-10">Device Serial</label>
															<input type="text" class="form-control" id="deviceSerialNumber" name="deviceSerialNumber" placeholder="Hardware device serial number" required value="">
															<span class="help-block">Device serial number</span>
														</div>
														<div class="form-group">
														...
														<div class="form-group">
															...
															<span class="help-block">Software</span>
														</div>
														<div class="form-group">
															...
															<span class="help-block">Software version</span>
														</div>
														<div class="form-group">
															...
															<span class="help-block">Software manufacturer</span>
														</div>
														<div class="form-group">
												...
												<div class="form-group mb-0">
													<input type="hidden" class="form-control" id="category" name="category" required value="IoT Agent">
