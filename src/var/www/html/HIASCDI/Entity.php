...
$cb = $HiasInterface->get_hiascdi_entity("dateCreated,dateModified,*");
    ...
    <body id="GeniSysAI">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="panel panel-default card-view panel-refresh">
                                <div class="panel-heading">
                                    <div class="pull-left">
                                        <h6 class="panel-title txt-dark">HIASCDI Entity</h6>
                                    </div>
                                    <div class="pull-right"><a href="/HIASCDI/Configuration" download><i class="fas fa-download"></i> HIASCDI Configuration</a></div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <p>HIASCDI Entity type is a contextual representation of the HIAS Contextual Data Interface.</p>
                                                <p>&nbsp;</p>
                                        ...
                                        <div class="form-wrap">
                                            <form data-toggle="validator" role="form" id="update_hiascdi_form">
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                                        <div class="form-group">
                                                            <label for="name" class="control-label mb-10">Name</label>
                                                            <input type="text" class="form-control" id="name" name="name" placeholder="Name of Context Broker" required value="<?=$cb["name"]["value"]; ?>">
                                                            <span class="help-block">Name of Context Broker</span>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="name" class="control-label mb-10">Description</label>
                                                            <input type="text" class="form-control" id="description" name="description" placeholder="Context Broker Description" required value="<?=$cb["description"]["value"]; ?>">
                                                            <span class="help-block">Description of Context Broker</span>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="name" class="control-label mb-10">Version</label>
                                                            <input type="text" class="form-control" id="version" name="version" placeholder="Context Broker Version" required value="<?=$cb["version"]["value"]; ?>">
                                                            <span class="help-block">Context Broker Version</span>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="name" class="control-label mb-10">Host</label>
                                                            <input type="text" class="form-control  hider" id="host" name="host" placeholder="Context Broker Host" required value="<?=$cb["host"]["value"]; ?>">
                                                            <span class="help-block">Context Broker Host</span>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="name" class="control-label mb-10">Port</label>
                                                            <input type="text" class="form-control hider" id="port" name="port" placeholder="Context Broker Port" required value="<?=$cb["port"]["value"]; ?>">
                                                            <span class="help-block">Context Broker Port</span>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="name" class="control-label mb-10">Endpoint</label>
                                                            <input type="text" class="form-control hider" id="endpoint" name="endpoint" placeholder="Context Broker Endpoint" required value="<?=$cb["endpoint"]["value"]; ?>">
                                                            <span class="help-block">Context Broker Endpoint</span>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="name" class="control-label mb-10">Device Brand Name</label>
                                                            <input type="text" class="form-control" id="deviceBrandName" name="deviceBrandName" placeholder="Device Brand Name" required value="<?=$cb["deviceBrandName"]["value"]; ?>">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="deviceModel" name="deviceModel" placeholder="Device Model" required value="<?=$cb["deviceModel"]["value"]; ?>">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="deviceManufacturer" name="deviceManufacturer" placeholder="Device Manufacturer" required value="<?=$cb["deviceManufacturer"]["value"]; ?>">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="deviceSerialNumber" name="deviceSerialNumber" placeholder="Device Manufacturer" required value="<?=$cb["deviceSerialNumber"]["value"]; ?>">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="os" name="os" placeholder="Operating system name" required value="<?=$cb["os"]["value"]; ?>">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="osVersion" name="osVersion" placeholder="Operating System Version" required value="<?=$cb["osVersion"]["value"]; ?>">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="osManufacturer" name="osManufacturer" placeholder="Operating System manufacturer" required value="<?=$cb["osManufacturer"]["value"]; ?>">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="software" name="software" placeholder="Software" required value="<?=$cb["software"]["value"]; ?>">
                                                            <span class="help-block">HIAS software</span>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="name" class="control-label mb-10">Software Version</label>
                                                            <input type="text" class="form-control" id="softwareVersion" name="softwareVersion" placeholder="Software Version" required value="<?=$cb["softwareVersion"]["value"]; ?>">
                                                            <span class="help-block">HIAS software version</span>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="name" class="control-label mb-10">Software Manufacturer</label>
                                                            <input type="text" class="form-control" id="softwareManufacturer" name="softwareManufacturer" placeholder="Software Manufacturer" required value="<?=$cb["softwareManufacturer"]["value"]; ?>">
                                                    ...
                                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="lid" name="lid" required>
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <option value="<?=$value["id"]; ?>" <?=$value["id"] == $cb["networkLocation"]["value"] ? " selected " : ""; ?>><?=$value["name"]["value"]; ?></option>
                                                            ...
                                                            <span class="help-block">Location that HIASCDI is installed in</span>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="zid" name="zid" required>
                                                                ...
                                                                <option value="<?=$value["id"]; ?>" <?=$cb["networkZone"]["value"] == $value["id"] ? " selected " : ""; ?>><?=$value["name"]["value"]; ?></option>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="coordinates" name="coordinates" placeholder="iotJumpWay Location coordinates" required value="<?=$cb["location"]["value"]["coordinates"][0]; ?>, <?=$cb["location"]["value"]["coordinates"][1]; ?>">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="protocols" name="protocols[]" required multiple>
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <option value="<?=$value["protocol"]; ?>" <?=in_array($value["protocol"], $cb["protocols"]["value"]) ? " selected " : ""; ?>><?=$value["protocol"]; ?></option>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control hider" id="ipAddress" name="ipAddress" placeholder="IP Address Of Context Broker" required value="<?=$cb["ipAddress"]["value"]; ?>">
                                                            <span class="help-block">IP Address Of Context Broker</span>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="name" class="control-label mb-10">MAC</label>
                                                            <input type="text" class="form-control hider" id="macAddress" name="macAddress" placeholder="MAC Address Of Context Broker" required value="<?=$cb["macAddress"]["value"] ? $cb["macAddress"]["value"] : ""; ?>">
                                                            <span class="help-block">MAC Address Of Context Broker</span>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="name" class="control-label mb-10">Bluetooth Address</label>
                                                            <input type="text" class="form-control hider" id="bluetooth" name="bluetooth" placeholder="Device Bluetooth Address"  value="<?=$cb["bluetoothAddress"]["value"]; ?>">
                                                            <span class="help-block">Bluetooth address of device</span>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="name" class="control-label mb-10">Date Created</label>
                                                            <p><?=$cb["dateCreated"]["value"]; ?></p>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="name" class="control-label mb-10">Date First Used</label>
                                                            <p><?=$cb["dateFirstUsed"]["value"] ? $cb["dateFirstUsed"]["value"] : "NA"; ?></p>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="name" class="control-label mb-10">Date Modified</label>
                                                            <p><?=$cb["dateModified"]["value"]; ?></p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group mb-0">
                                                    <input type="hidden" class="form-control" id="update_hiascdi" name="update_hiascdi" required value=True>
                                                    <button type="submit" class="btn btn-success btn-anim" id="update_hiascdi_submit"><i class="icon-rocket"></i><span class="btn-text">Update</span></button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="panel panel-default card-view panel-refresh">
                                <div class="panel-heading">
                                    <div class="pull-left">
                                        <h6 class="panel-title txt-dark">HIASCDI Schema</h6>
                                    </div>
                                    <div class="pull-right"></div>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="panel-wrapper collapse in">
                                    <div class="panel-body">
                                        <div  style="height: 400px; overflow-y: scroll; overflow-x: hidden;">
                                            <?php echo "<pre id='schema'>"; ?> <?php print_r(json_encode($cb, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES)); ?> <?php echo "</pre>"; ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="panel panel-default card-view panel-refresh">
                                <div class="panel-wrapper collapse in">
                                    <div class="panel-body">
                                        <div class="pull-right"><a href="javascipt:void(0)" id="reset_dvc_apriv"><i class="fa fa-refresh"></i> Reset Network Key</a></div>
                                        <div class="form-group">
                                            <label class="control-label col-md-5">Network Identifier</label>
                                            <div class="col-md-9">
                                                <p class="form-control-static hiderstr" id="network_identifier"><?=$cb["id"]; ?></p>
                                                <p><strong>Last Updated:</strong> <?=$cb["authenticationKey"]["metadata"]["timestamp"]["value"]; ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="panel-wrapper collapse in">
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <p class="form-control-static hiderstr" id="hiascdi_blockchain_address"><?=$cb["authenticationBlockchainUser"]["value"]; ?></p>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-5">Blockchain Key</label>
                                            <div class="col-md-9">
                                                <p class="form-control-static hiderstr" id="hiascdi_blockchain_key"><?=$HIAS->helpers->oDecrypt($cb["authenticationBlockchainKey"]["value"]); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="panel-wrapper collapse in">
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <p class="form-control-static hiderstr" id="hiascdi_mqqt_username"><?=$HIAS->helpers->oDecrypt($cb["authenticationMqttUser"]["value"]); ?></p>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-5">MQTT Password</label>
                                            <div class="col-md-9">
                                                <p class="form-control-static"><span id="hiascdi_mqqt_password" class="hiderstr"><?=$HIAS->helpers->oDecrypt($cb["authenticationMqttKey"]["value"]); ?></span>
                                                <p><strong>Last Updated:</strong> <?=$cb["authenticationMqttKey"]["metadata"]["timestamp"]["value"]; ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="panel-wrapper collapse in">
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <p class="form-control-static hiderstr" id="damqpu"><?=$HIAS->helpers->oDecrypt($cb["authenticationAmqpUser"]["value"]); ?></p>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-5">AMQP Password</label>
                                            <div class="col-md-9">
                                                <p class="form-control-static hiderstr"><span id="damqpp"><?=$HIAS->helpers->oDecrypt($cb["authenticationAmqpKey"]["value"]); ?></span>
                                                <p><strong>Last Updated:</strong> <?=$cb["authenticationAmqpKey"]["metadata"]["timestamp"]["value"]; ?></p>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
        ...
        <script type="text/javascript">
            ...
            function initMap() {
                ...
                var latlng = new google.maps.LatLng("<?=floatval($cb["location"]["value"]["coordinates"][0]); ?>", "<?=floatval($cb["location"]["value"]["coordinates"][1]); ?>");
                var map = new google.maps.Map(document.getElementById('map1'), {
                    zoom: 10,
                    center: latlng
                });

                var loc = new google.maps.LatLng(<?=floatval($cb["location"]["value"]["coordinates"][0]); ?>, <?=floatval($cb["location"]["value"]["coordinates"][1]); ?>);
