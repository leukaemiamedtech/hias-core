        ...
        <script type="text/javascript" src="/vendors/bower_components/bootstrap/dist/js/bootstrap.js"></script>
        <script type="text/javascript" src="/vendors/bower_components/jasny-bootstrap/dist/js/jasny-bootstrap.min.js"></script>
        <script type="text/javascript" src="/vendors/bower_components/jquery-toast-plugin/dist/jquery.toast.min.js"></script>
        <script type="text/javascript" src="/vendors/bower_components/bootstrap-validator/dist/validator.min.js"></script>
        ...
        <script type="text/javascript" src="/Media/JS/HIAS.js"></script>
        <script type="text/javascript" src="/Media/JS/Logging.js"></script>
