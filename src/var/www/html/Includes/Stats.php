										...
										<div class="container-fluid">
											<div class="row">
												<div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
													<span class="txt-light block counter">CPU<br /><span class="up_cpu"><?=isSet($stats["cpu"]) ? $stats["cpu"] : 0; ?></span>%</span>
										...
										<div class="container-fluid">
											<div class="row">
												<div class="col-xs-6 text-center pl-0 pr-0 txt-light data-wrap-left">
													<span class="block counter">Memory<br /><span class="up_mem"><?=isSet($stats["mem"]) ? $stats["mem"] : 0; ?></span>%</span>
								...
								<div class="panel-body pa-0">
									<div class="sm-data-box">
										<div class="container-fluid">
											<div class="row">
												<div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
													<span class="txt-light block counter">HDD<br /><span class="up_hdd"><?=isSet($stats["hdd"]) ? $stats["hdd"] : 0; ?></span>%</span>
								...
								<div class="panel-body pa-0">
									<div class="sm-data-box">
										<div class="container-fluid">
											<div class="row">
												<div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
													<span class="txt-light block counter">Temp<br /><span class="up_tempr"><?=isSet($stats["tempr"]) ? $stats["tempr"] : 0; ?></span>°C</span>
													<span class="weight-500 uppercase-font block txt-light">SERVER</span>
												</div>
												<div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
