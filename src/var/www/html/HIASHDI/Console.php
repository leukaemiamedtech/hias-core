...
$cb = $HiasHdiInterface->get_hiashdi_entity();
...
<html lang="en">
	...
	<body id="GeniSysAI">
		...
		<div class="wrapper theme-6-active pimary-color-pink">
					...
					<div class="row">
						<div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
							<div class="panel panel-default card-view panel-refresh">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">HIASHDI Console</h6>
									</div>
									...
									<div class="panel-body">
										...
										<div class="row">
											<div class="col-lg-12">
												...
												<p>HIASHDI Console allows you to send real-time requests to the HIASHDI broker.  Read the official <a href="https://docs.haiscdi.hias.network/" target="_BLANK">HIASHDI Documentation</a> for more information.</p>
												<p>&nbsp;</p>
										...
										<div class="form-wrap">
											<form data-toggle="validator" role="form" id="hiashdi_console_form">
												...
												<div class="row">
													...
													<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
														<div class="form-group">
															<select class="form-control" id="endpoint" name="endpoint" required>
																<option value="<?=$HIAS->hiashdi->confs["locations_url"]; ?>"><?=$HIAS->hiashdi->confs["locations_url"]; ?></option>
																<option value="<?=$HIAS->hiashdi->confs["zones_url"]; ?>"><?=$HIAS->hiashdi->confs["zones_url"]; ?></option>
																<option value="<?=$HIAS->hiashdi->confs["data_url"]; ?>"><?=$HIAS->hiashdi->confs["data_url"]; ?></option>
																<option value="<?=$HIAS->hiashdi->confs["commands_url"]; ?>"><?=$HIAS->hiashdi->confs["commands_url"]; ?></option>
																<option value="<?=$HIAS->hiashdi->confs["subscriptions_url"]; ?>"><?=$HIAS->hiashdi->confs["subscriptions_url"]; ?></option>
													...
													<div class="col-lg-2 col-md-12 col-sm-12 col-xs-12">
														<div class="form-group mb-0">
															<input type="hidden" class="form-control" id="send_hiashdi_console" name="send_hiashdi_console" value=True>
			...
			<script type="text/javascript" src="/iotJumpWay/Classes/iotJumpWay.js?time=<?=time(); ?>"></script>
			<script type="text/javascript" src="/iotJumpWay/Classes/iotJumpWayUI.js?time=<?=time(); ?>"></script>
