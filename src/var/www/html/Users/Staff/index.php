				...
				<div class="row">
					<div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-default card-view panel-refresh">
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									...
									<p>The HIAS staff area allows you to create and manage users that have access to the HIAS UI.</p>
						...
						<div class="panel panel-default card-view panel-refresh">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark"><i class="fa fa-users"></i> Active Staff</h6>
								</div>
										...
										<div class="table-responsive">
											<table class="table mb-0">
												...
												<?php
													...
													$Staffs = $Staff->get_staff_members(0, "id DESC", $attrs, "permissionsCancelled.value==False");
